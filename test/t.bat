...
set  span_provide=-Dspan_CONFIG_PROVIDE_CONSTRUCTION_FROM_STDARRAY_ELEMENT_TYPE=1 -Dspan_CONFIG_PROVIDE_WITH_CONTAINER_TO_STD=99 -Dspan_CONFIG_PROVIDE_BACK_FRONT=1 -Dspan_CONFIG_PROVIDE_SWAP=1 -Dspan_CONFIG_PROVIDE_SAME=1 -Dspan_CONFIG_PROVIDE_MAKE_SPAN_TO_STD=99 -Dspan_CONFIG_PROVIDE_BYTE_SPAN=1
