...
set   spanFeatures="span_CONFIG_PROVIDE_WITH_CONTAINER_TO_STD=99" span_CONFIG_PROVIDE_CONSTRUCTION_FROM_STDARRAY_ELEMENT_TYPE span_CONFIG_PROVIDE_BACK_FRONT span_CONFIG_PROVIDE_SAME "span_CONFIG_PROVIDE_MAKE_SPAN_TO_STD=99" span_CONFIG_PROVIDE_BYTE_SPAN
