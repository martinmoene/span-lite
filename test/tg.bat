...
set back_front=-Dspan_CONFIG_PROVIDE_BACK_FRONT=1

set     flags=-Wpedantic -Wno-padded -Wno-missing-noreturn
set       gpp=g++

%gpp% -std=%std% -O2 -Wall -Wextra %flags% %stdspn% %contract% %make_span% %byte_span% %back_front% -o span-main.t.exe -I../include/nonstd span-main.t.cpp span.t.cpp && span-main.t.exe
endlocal
